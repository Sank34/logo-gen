...
module.exports.run = async (bot, message, args) => {
    ...
    if (!question) {
        ...
        const cat = new Discord.MessageEmbed()
            ...
            .setURL(`https://dynamic.brandcrowd.com/asset/logo/4a0312ef-6f47-421d-9d10-354c27de8e0f/logo?v=4&text=${encodedQuestion}`)
            .setImage(`https://dynamic.brandcrowd.com/asset/logo/4a0312ef-6f47-421d-9d10-354c27de8e0f/logo?v=4&text=${encodedQuestion}`)
