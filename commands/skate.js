...
module.exports.run = async (bot, message, args) => {
    ...
    if (!question) {
        ...
        const text = new Discord.MessageEmbed()
            ...
            .setURL(`https://flamingtext.com/net-fu/proxy_form.cgi?imageoutput=true&script=skate-logo&text=${encodedQuestion}`)
            .setImage(`https://flamingtext.com/net-fu/proxy_form.cgi?imageoutput=true&script=skate-logo&text=${encodedQuestion}`)
