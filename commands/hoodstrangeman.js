...
module.exports.run = async (bot, message, args) => {
    ...
    if (!question) {
        ...
        const cat = new Discord.MessageEmbed()
            ...
            .setURL(`https://dynamic.brandcrowd.com/asset/logo/bbf8e7fe-13c2-420c-bb2c-9c059744d599/logo?v=4&text=${encodedQuestion}`)
            .setImage(`https://dynamic.brandcrowd.com/asset/logo/bbf8e7fe-13c2-420c-bb2c-9c059744d599/logo?v=4&text=${encodedQuestion}`)
