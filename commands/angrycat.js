...
module.exports.run = async (bot, message, args) => {
    ...
    if (!question) {
        ...
        const cat = new Discord.MessageEmbed()
            ...
            .setURL(`https://dynamic.brandcrowd.com/asset/logo/065b4535-d123-4261-accb-2f21e3eac3cf/logo?v=4&text=${encodedQuestion}`)
            .setImage(`https://dynamic.brandcrowd.com/asset/logo/065b4535-d123-4261-accb-2f21e3eac3cf/logo?v=4&text=${encodedQuestion}`)
