...
module.exports.run = async (bot, message, args) => {
    ...
    if (!question) {
        ...
        const cat = new Discord.MessageEmbed()
            ...
            .setURL(`https://dynamic.brandcrowd.com/asset/logo/b97103b8-3b7c-4f1d-8c91-451c11e8cde3/logo?v=4&text=${encodedQuestion}`)
            .setImage(`https://dynamic.brandcrowd.com/asset/logo/b97103b8-3b7c-4f1d-8c91-451c11e8cde3/logo?v=4&text=${encodedQuestion}`)
